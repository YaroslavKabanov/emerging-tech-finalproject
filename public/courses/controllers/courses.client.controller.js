angular.module('courses').controller('CoursesController', ['$scope', '$routeParams', '$location', 'Authentication', 'Courses', 'CourseStudent','Classmates',
    function($scope, $routeParams, $location, Authentication, Courses, CourseStudent,Classmates) {
